  ...
  return (
    <div className="w-3/5">
      <div className="flex flex-col pr-16">
        ...
        <h2 className="my-6 text-4xl font-semibold capitalize">tray table</h2>
        <p className="mb-4 text-sm leading-6 text-neutral-04 line-clamp-4">
        ...
        <div className="flex items-center gap-4 pb-6 mb-6 font-semibold border-b-2">
